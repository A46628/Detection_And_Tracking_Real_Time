...
class RepConv_OREPA(nn.Module):
    ...
    def __init__(self, c1, c2, k=3, s=1, padding=1, dilation=1, groups=1, padding_mode='zeros', deploy=False, use_se=False, nonlinear=nn.LeakyReLU(0.1015625, inplace=True)):
...
class Mlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=lambda: nn.LeakyReLU(0.1015625, inplace=True), drop=0.):
        super().__init__()
...
class SwinTransformerLayer(nn.Module):
    ...
    def __init__(self, dim, num_heads, window_size=8, shift_size=0,
                 ...
                 act_layer=lambda: nn.LeakyReLU(0.1015625, inplace=True), norm_layer=nn.LayerNorm):
        super().__init__()
        self.dim = dim
        self.num_heads = num_heads
...
class SwinTransformerLayer_v2(nn.Module):
    ...
    def __init__(self, dim, num_heads, window_size=7, shift_size=0,
                 ...
                 act_layer=lambda: nn.LeakyReLU(0.1015625, inplace=True), norm_layer=nn.LayerNorm, pretrained_window_size=0):
        super().__init__()
        self.dim = dim
