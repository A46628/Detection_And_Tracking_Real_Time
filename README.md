...
The tracking pipeline receives the detections generated by YOLO and associates them across consecutive video frames.
...
The approach separates object detection from temporal tracking, allowing the detector and tracker to be independently optimized.
